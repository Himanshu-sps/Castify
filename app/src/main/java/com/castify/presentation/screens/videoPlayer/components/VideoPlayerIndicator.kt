package com.castify.presentation.screens.videoPlayer.components
...
fun RowScope.VideoPlayerControllerIndicator(
    ...
    val color by rememberUpdatedState(
        newValue = if (isSelected) MaterialTheme.colorScheme.error
        else MaterialTheme.colorScheme.onSurface
    )

    val trackColor by rememberUpdatedState(
        newValue =  MaterialTheme.colorScheme.onSurface
    )
    ...
    val handleSeekEventModifier = Modifier.handleDPadPreviewKeyEvents(
        onEnter = {
            isSelected = !isSelected
            onSeek(seekProgress)
            onRegainFocus.invoke()
        },
        onLeft = {
    ...
    val handleDpadCenterClickModifier = Modifier.handleDPadPreviewKeyEvents(
        onEnter = {
